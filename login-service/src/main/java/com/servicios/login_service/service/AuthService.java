...
public class AuthService {
    ...
    /**
     * Recibe email, contraseña sin cifrar y tipo de usuario (CLIENTE o EMPLEADO),
    ...
    public String login(String email, String rawPassword, String tipo) {
        ...
        // Generación del JWT con id, email y rol del usuario
        String token = jwtUtil.generateToken(u.getId(), u.getEmail(), u.getRol());

        System.out.println("TOKEN GENERADO:");
        System.out.println(token);  // Muestra el JWT completo en consola
